...
- Browser-provided AI endpoints are allowed only for local testing. Production/shared deployments should use `OPENAI_CHAT_HOST` from the host/container environment.
